...
namespace WebAPI.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> InsertCustomer(InsertCustomer categoryModel)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> UpdateCustomer(UpdateCustomer categoryModel)
        {
            if (ModelState.IsValid)
            {
